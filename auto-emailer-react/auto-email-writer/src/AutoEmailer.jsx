                ...
                <div className=" gap-10 items-center">
                    <div>
                        ...
                        <motion.h1
                            ...
                            className="text-4xl sm:text-5xl font-extrabold tracking-tight text-center mb-8"
                        >
                        ...
                        >
                            ...
                            <Box>
                                ...
                                <Button variant="contained" color="success" onClick={handleSubmit} disabled={loading || !emailContent} fullWidth>
